            ...
            >
              <div className={styles.row}>
                <Radio
                  ...
                  value={repeatFrequency === RepeatTypes.DAILY}
                ...
                {repeatFrequency === RepeatTypes.DAILY && (
                  <div className={styles.repeatDetail}>
                    ...
                    {repeatRule?.repeatEndType === RepeatEndTypes.COUNT && (
                      <RepeatCountNode
                        value={repeatRule?.count}
                        onChange={onChangeRepeatRule}
                      />
                    )}
                    {repeatRule?.repeatEndType === RepeatEndTypes.UNTIL && (
                      <RepeatUntilNode
              ...
              <div className={styles.row}>
                <Radio
                  ...
                  value={repeatFrequency === RepeatTypes.WEEKLY}
                  onChange={onChangeRepeatRule}
                >
                  주 반복
                </Radio>
              ...
              <div className={styles.row}>
                <Radio
                  ...
                  value={repeatFrequency === RepeatTypes.MONTHLY}
                  onChange={onChangeRepeatRule}
                >
                  월 반복
                </Radio>
              ...
              <div className={styles.row}>
                <Radio
                  ...
                  value={repeatFrequency === RepeatTypes.YEARLY}
                  onChange={onChangeRepeatRule}
                >
                  연 반복
                </Radio>
                {repeatFrequency === RepeatTypes.YEARLY && (
                  <div className={styles.repeatDetail}>
                    ...
                    <span>
                      년 주기로{" "}
                      {plan.startedAt
                        ? plan.startedAt.split("T")[0].split("-")[1] || " - "
                        : ""}
                      월{" "}
                      {plan.startedAt
                        ? plan.startedAt.split("T")[0].split("-")[2] || " - "
                        : ""}
                      일마다
                    </span>
                    <RepeatEndTypeSelect
