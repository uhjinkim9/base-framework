...
export default function AddPoll() {
  ...
  function onClickAddSelection(questionTempId?: string, questionIdx?: number) {
    dispatch({
      type: "ADD_SELECTION",
      payload: {
  ...
  return (
    <div className={styles.componentContainer}>
      ...
      <SortableList
        ...
        getId={(q: QuestionType) => q.questionTempId || String(q.questionIdx)}
        ...
        renderItem={(question, qIdx, dragHandleProps) => (
          ...
          >
            <div className={clsx(styles.row, styles.questionOptions)}>
              <div className={styles.iconRow}>
                <SelectBox
              ...
              >
                <IconNode iconName="cross" size={14} color="gray4" />
              </span>
            </div>
            ...
            <div className={clsx("row", styles.questionContent)}>
              ...
              <div className={styles.dragHandle} {...dragHandleProps}>
                <IconNode iconName="dragHandle" size={16} color="gray4" />
              </div>
              <InputTextArea
            ...
            <SortableList
              ...
              getId={(s) => s.selectionTempId || String(s.selectionIdx)}
              ...
              onChange={(reordered) =>
                dispatch({
                  ...
                  payload: {
                    questionTempId: question.questionTempId,
                    questionIdx: question.questionIdx,
                    selections: reordered.map((sel, idx) => ({
                      ...sel,
                      order: idx + 1,
                    })),
                  },
              ...
              renderItem={(selection, selIdx, dragHandleProps) => (
                <div
                  key={selection.selectionTempId || selection.selectionIdx}
                  className={clsx(styles.row, styles.selectionsAdded)}
                >
                  {checkIsSelectableType(question.responseType) && (
                    <div
                      ...
                      {...(checkIsSelectableType(question.responseType)
                        ...
                        : {})}
                    >
                      <IconNode iconName="dragHandle" size={14} color="gray4" />
                    </div>
                  )}
                    ...
                    responseTypeMap[question.responseType]({
                      ...
                      onChange: (e) =>
                        onChangeSelection(e, {
                          questionTempId: question.questionTempId,
                          questionIdx: question.questionIdx,
                          selectionTempId: selection.selectionTempId,
                          selectionIdx: selection.selectionIdx,
                        }),
                    })}
                  ...
                  {checkIsSelectableType(question.responseType) && (
                    ...
                    >
                      <IconNode iconName="cross" size={12} color="gray4" />
                    </span>
                  )}
                </div>
              )}
            ...
            {checkIsSelectableType(question.responseType) && (
              <div className={clsx("row", styles.selAddBtn)}>
                <Button
                  onClick={() =>
                    onClickAddSelection(
                      question.questionTempId || undefined,
      ...
      {(mode === "add" || mode === "edit") && (
        <Button
          onClick={() => onClickAddQuestion(poll?.pollTempId, poll?.pollIdx)}
          width="100%"
          onHoverOpaque
