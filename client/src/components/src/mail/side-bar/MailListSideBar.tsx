...
export default function MailListSideBar() {
  ...
  const onClickAdd = () => {
    router.push(`/${mainMenu}/${subMenu}/write-mail`);
  };

  const onClickAddMailFolder = async () => {
    try {
...
// 			<div className={styles.menuSection}>
// 				<ul className={styles.subMenuList}>
// 					{mailMenus?.map((m: SideBarMenuType) => (
